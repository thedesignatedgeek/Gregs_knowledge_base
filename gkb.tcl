...
#  Jan 08, 2024 08:55:54 AM CST  platform: Linux
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 1010x754+809+248
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
Copyright © 2023,2024 by Gregory Walters" \
    ...
    ttk::label "$site_5_0.tLa52" \
        -font "-family {DejaVu Sans} -size 11 -weight bold" -relief flat \
        -anchor center -justify left -text "Editor" -compound left 
    ...
    place $site_5_0.tLa52 \
        -in $site_5_0 -x 10 -y 10 -width 121 -relwidth 0 -height 24 \
        -relheight 0 -anchor nw -bordermode ignore 
    ...
    vTcl::widgets::ttk::scrolledtext::CreateCmd "$site_6_0.scr58" \
        -borderwidth 2 -relief groove -background cornsilk4 -height 374 \
        -width 644 
    ...
    vTcl::widgets::ttk::scrolledlistbox::CreateCmd "$site_6_0.scr57" \
        -background cornsilk4 -height 377 -width 298 
