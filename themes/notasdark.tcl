...
namespace eval ttk::theme::notasdark {
    variable version 0.2.1
    package provide ttk::theme::notasdark $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
    ...
    # Settings
    ttk::style theme create notasdark -parent clam -settings {
        ...
        load_images [file join [file dirname [info script]] notasdark]
        ...
        ttk::style configure TButton \
            -anchor center -width -20 -padding {6 2 6 2} -relief raised \
        ...
        ttk::style element create Button.button image \
            [list $I(btn-n) \
                {selected disabled} $I(btn-n) \
                disabled $I(btn-n) \
                selected $I(btn-n) \
                pressed $I(btn-p) \
                active $I(btn-h) \
            ] -border {8 4} -sticky we
            
        ttk::style map TButton \
                -background [list pressed gray69 \
