...
namespace eval ttk::theme::cornsilk-dark {
    variable version 0.1.19
    package provide ttk::theme::cornsilk-dark $version
    variable colors
    array set colors {
        -disabledfg     gray54
        -frame          black
    ...
    # Settings
    ttk::style theme create cornsilk-dark -parent clam -settings {
        ...
        ttk::style map TNotebook.Tab \
            ...
            -background [list selected $colors(-bgcolor) active ivory2 \
            !active cornsilk3] \
